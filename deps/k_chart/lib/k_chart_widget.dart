...
class TimeFormat {
  static const List<String> YEAR_MONTH_DAY = [
    yyyy,
    '-',
    mm,
    '-',
      ...
      builder: (context, constraints) {
        ...
        return GestureDetector(
          ...
          onScaleUpdate: (details) {
            ...
            mScaleX = (_lastScale * details.scale).clamp(0.5, 4);
            notifyChanged();
          },
          onScaleEnd: (_) {
            isScale = false;
    ...
    return StreamBuilder<InfoWindowEntity?>(
        ...
        builder: (context, snapshot) {
          ...
          infos = [
            ...
            '${(((entity.close - entity.open) / entity.open) * 100).toStringAsFixed(2)}%',
            '${(((entity.high - entity.low) / entity.open) * 100).toStringAsFixed(2)}%',
