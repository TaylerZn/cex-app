...
class _ContractApi implements ContractApi {
  _ContractApi(
    this._dio, {
    this.baseUrl,
  });
  ...
  @override
  Future<PublicInfo> getPublicInfo() async {
    const _extra = <String, dynamic>{'k_Retry': true};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PublicInfo>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PublicInfo.fromJson(_result.data!);
    return value;
  }
  ...
  Future<LangInfo> getLocale(
    ...
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<LangInfo>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = LangInfo.fromJson(_result.data!);
    return value;
  }
  ...
  Future<UserConfigInfo?> getUserConfig(contractId) async {
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value =
        _result.data == null ? null : UserConfigInfo.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<UserOrderCount> getUserOrderCount() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<UserOrderCount>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/order/get_user_order_count',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = UserOrderCount.fromJson(_result.data!);
    return value;
  }
  ...
  Future<ChangePositionAmountInfo> queryChangePositionAmount(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/position/query_change_position_margin',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<dynamic> contractAnswer() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<dynamic> openTrade() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
