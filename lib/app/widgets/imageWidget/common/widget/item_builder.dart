import 'package:nt_app_flutter/app/widgets/imageWidget/common/data/tu_chong_repository.dart';
        ...
        child: Container(
          ...
          child: Text(
            ...
            style: const TextStyle(
                height: 1, fontSize: fontSize, color: Colors.white),
          ),
        ),
      ),
    ],
      ...
      Row(
        children: <Widget>[
          ...
          Text(
            item.comments.toString(),
            style: const TextStyle(
                height: 1, color: Colors.black, fontSize: fontSize),
          )
        ],
      ),
      const SizedBox(
      ...
      LikeButton(
        ...
        countBuilder: (int? count, bool isLiked, String text) {
          ...
          if (count == 0) {
            result = Text(
              'love',
              style: TextStyle(height: 1, color: color, fontSize: fontSize),
            );
          } else {
            result = Text(
