...
class MySendCode extends StatefulWidget {
  ...
  @override
  _MySendCodeState createState() => _MySendCodeState();
}

class _MySendCodeState extends State<MySendCode>
      ...
      if (countDown == 0) {
        ...
        switch (widget.sendCodeType) {
          ...
          case UserSafeVerificationEnum.EMAIL_FORGOT:
            ...
            setInitResendTimer(res);
            break;
          case UserSafeVerificationEnum.AUTH_UNBIND:
            var data = {
              'operationType': widget.sendCodeType.value,
            };
            res = await commonemailValidCode(data);
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          countDown != 0
              ...
              : Text(
                  firstGetCode
                      ? LocaleKeys.public44.tr
                      : LocaleKeys.public45.tr,
                  style: AppTextStyle.f_14_400.copyWith(
                      color: firstGetCode
                          ? AppColor.color333333
                          : AppColor.color0075FF)),
          widget.isKeepleft ? 0.horizontalSpace : 16.horizontalSpace
        ],
      ),
    );
  }
