    ...
    return Row(
      children: [
        Container(
          width: 4.w,
          height: 4.w,
          color: widget.chartColors.depthBuyColor,
          margin: EdgeInsets.only(right: 3.w),
        ),
        Text(
          LocaleKeys.trade286.tr,
        ...
        Container(
          ...
          height: 4.w,
          margin: EdgeInsets.only(right: 3.w),
          color: widget.chartColors.depthSellColor,
        ),
        Text(
          LocaleKeys.trade287.tr,
          style: AppTextStyle.f_10_500.colorTextPrimary,
        ),
      ],
    );
...
class DepthChartPainter extends CustomPainter {
  ...
  DepthChartPainter(
    ...
    mBuyPathPaint ??= Paint()
      ..isAntiAlias = true
      ..color = (mBuyPathColor ?? chartColors.depthBuyColor.withOpacity(0.5));
    mSellPathPaint ??= Paint()
      ..isAntiAlias = true
      ..color = (mSellPathColor ?? chartColors.depthSellColor.withOpacity(0.5));
    mBuyPath ??= Path();
    mSellPath ??= Path();
    init();
  }
  ...
  getTextPainter(String text, [Color color = Colors.black54]) => TextPainter(
      text:
