...
class BindingVerificationView extends GetView<BindingVerificationController> {
  const BindingVerificationView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return MySystemStateBar(
        child: Scaffold(
            ...
            body: GetBuilder<BindingVerificationController>(
