...
class LoginForgotPwdView extends GetView<LoginForgotPwdController> {
  const LoginForgotPwdView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<LoginForgotPwdController>(builder: (controller) {
