...
class MySafeC2CWithdrawallController extends GetxController {
  String smsCode = '';
  String emailCode = '';
  String googleCode = '';
  final int verifCount;
  MySafeC2CWithdrawallController({this.verifCount = 2});
  ...
  verificationGo(type) async {
    ...
    final res = await Get.toNamed(Routes.MY_SAFE_WITHDRAWAL_VERIFICATION,
