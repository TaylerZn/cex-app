...
import '../model/assets_funds_tab_model.dart';

//

class AssetsFundsInfoTabbar extends StatelessWidget {
  const AssetsFundsInfoTabbar(
      {super.key,
      ...
      this.labelStyle});
  final List<AssetsFundsTabModel> dataArray;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TabBar(
        ...
        labelPadding:
            EdgeInsets.only(left: 16.w, right: 16.w, top: 0.h, bottom: 0),
